...
class Admin extends CI_Controller
{
  ...
  public function index()
  {
    ...
    // Hitung jumlah data pada tabel Karakteristik/Varietas/Pengetahuan
    // $data['totalKarakteristik'] = $this->Adm->CountKarakteristik();
    // $data['totalVarietas'] = $this->Adm->CountVarietas();
    // $data['totalPengetahuan'] = $this->Adm->CountPengetahuan();
    // $data['totalLaporan'] = $this->Adm->CountLaporan();
    // $data['totalTes'] = $this->Adm->CountTes();
