<!-- Modal Tambah -->
<div class="modal fade" id="tambahVarietas" tabindex="-1" role="dialog" aria-labelledby="forModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode varietas"
                        value="<?= $kode; ?>" readonly>
                </div>
