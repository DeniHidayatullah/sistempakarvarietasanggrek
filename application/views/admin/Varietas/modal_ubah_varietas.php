...
<?php foreach ($tbl_varietas as $vrs) : ?>
  <div class="modal fade ubahVarietas<?= $vrs['id_varietas']; ?>" tabindex="-1" role="dialog" aria-labelledby="forModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="kode" name="kode" value="<?= $vrs['kode_varietas']; ?>" readonly>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <img style="margin-bottom: 10px; width: 100px;" src=" <?= base_url('assets/images/varietas/') . $vrs['gambar']; ?>">
            <input type="file" class="form-control" id="gambar" name="gambar" value="<?= $vrs['gambar']; ?>"><?= $vrs['gambar']; ?>"
          </div>
          <div class="form-group">
            <label for="cara_perawatan">Cara Perawatan</label>
            <input type="cara_perawatan" class="form-control" name="cara_perawatan"><?= $vrs['cara_perawatan']; ?>
          </div>
        </div>
