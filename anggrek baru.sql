...
CREATE TABLE `tbl_uji` (
  ...
  `genius` varchar(20) NOT NULL,
  `akar` varchar(20) NOT NULL,
  `batang` varchar(20) NOT NULL,
  `daun` varchar(20) NOT NULL,
  `jumlah_mahkota` varchar(20) NOT NULL,
  `bentuk_mahkota` varchar(20) NOT NULL,
...
INSERT INTO `tbl_uji` (`id_uji`, `genius`, `akar`, `batang`, `daun`, `jumlah_mahkota`, `bentuk_mahkota`, `lidah`, `motif`) VALUES
(1, 'cattleya', 'epifit', 'simpodial', 'runcing', '5 helai', 'Seperti bintang', 'Ujung lancip', 'Dua warna');
